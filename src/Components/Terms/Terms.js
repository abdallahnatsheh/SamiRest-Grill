    ...
    <h1 id="Terms" style={style}>
      <Container style={{ padding: 10 }}>
        ...
        <div>
          ...
          related to it, still belong to Sami Restaurant and grill. Sami
          Restaurant and grill is committed to ensuring that the app is as
          ...
          paying for. The SamiRest-Grill app stores and processes personal data
          that you have provided to us, to provide our Service. It’s your
          ...
          SamiRest-Grill app won’t work properly or at all. The app does use
          ...
          * [Google Play Services](https://policies.google.com/terms) * [Google
          Analytics for Firebase](https://firebase.google.com/terms/analytics) *
          [Firebase Crashlytics](https://firebase.google.com/terms/crashlytics)
          * [Expo](https://expo.io/terms) You should be aware that there are
          certain things that Sami Restaurant and grill will not take
          ...
          provided by your mobile network provider, but Sami Restaurant and
          grill cannot take responsibility for the app not working at full
          ...
          third-party charges. In using the app, you’re accepting responsibility
          ...
          the same lines, Sami Restaurant and grill cannot always take
          ...
          can’t turn it on to avail the Service, Sami Restaurant and grill
          cannot accept responsibility. With respect to Sami Restaurant and
          grill’s responsibility for your use of the app, when you’re using the
          ...
          available to you. Sami Restaurant and grill accepts no liability for
          ...
          update the app. The app is currently available on – the requirements
          for the system(and for any additional systems we decide to extend the
          availability of the app to) may change, and you’ll need to download
          the updates if you want to keep using the app. Sami Restaurant and
          grill does not promise that it will always update the app so that it
          is relevant to you and/or works with the version that you have
        ...
        <div>
          ...
          this page. These terms and conditions are effective as of 2022-05-13
        </div>
        <div style={{ textAlign: "center", padding: 5, fontsize: 30 }}>
          **Contact Us**
        </div>
